...
echo -e "${NONE}"
if [ ! -d ~/wallpaper ]; then
    echo "Do you want to download the wallpapers from repository https://github.com/desbothma/wallpapers.git ?"
    ...
    if gum confirm "Do you want to download the repository?" ;then
        ...
        git clone --depth 1 https://github.com/mylinuxforwork/wallpaper/ ~/Downloads/wallpaper
        if [ ! -d ~/wallpaper/ ]; then
            mkdir ~/wallpaper
        fi
